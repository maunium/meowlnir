...
func init() {
	...
	protectionsRegistry["bad_words"] = protectionFactory[BadWords]()
	protectionsRegistry["bad_displaynames"] = protectionFactory[BadDisplayNames]()
	protectionsRegistry["max_mentions"] = protectionFactory[MaxMentions]()
	protectionsRegistry["join_rate"] = protectionFactory[MaxJoinRate]()
	protectionsRegistry["no_media"] = protectionFactory[NoMedia]()
	protectionsRegistry["insecure_registration"] = protectionFactory[InsecureRegistration]()
	protectionsRegistry["anti_flood"] = protectionFactory[AntiFlood]()
}
